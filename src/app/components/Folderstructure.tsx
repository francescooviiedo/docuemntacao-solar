...
import { List, ListItemButton, ListItemIcon, ListItemText, Button, Tooltip, Box, Divider } from '@mui/material';
    ...
    return (
        <>
            <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'flex-end' }}>
                <Tooltip title={expandAll ? "Recolher todas as pastas" : "Expandir ou recolher todas as pastas"}>
                    <Button variant="outlined" onClick={toggleExpandAll} sx={{ mb: 2 }}>
